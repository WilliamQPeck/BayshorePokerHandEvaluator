...
namespace PokerHandBayshoreCodeTest.Utilities
{
    // Put some of these static methods in this helpers class, I didn't like having them in the Card class itself
